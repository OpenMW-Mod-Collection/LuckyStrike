...
WeaponTypes = {
    ...
    [types.Weapon.TYPE.BluntOneHand]      = function(npc) return npc.type.stats.skills.blunt(npc) end,
    [types.Weapon.TYPE.BluntTwoClose]     = function(npc) return npc.type.stats.skills.blunt(npc) end,
    [types.Weapon.TYPE.BluntTwoWide]      = function(npc) return npc.type.stats.skills.blunt(npc) end,
